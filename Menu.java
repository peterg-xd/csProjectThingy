...
class FloorPlanListener implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    System.out.println("\nBefore arrange Students");
    System.out.println("Table list size: " + SystemManager.floorPlan.getTableList().size());
    System.out.println("student list size: " + SystemManager.enrollment.getStudentList().size());
    SystemManager.seatingPlan.arrangeStudents(SystemManager.floorPlan, SystemManager.enrollment.getStudentList());
    
     System.out.println("\nAfter arrange Students");
     System.out.println("Table list size: " +SystemManager.floorPlan.getTableList().size());
    System.out.println("student list size: " +SystemManager.enrollment.getStudentList().size());
