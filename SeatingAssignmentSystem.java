...
public class SeatingAssignmentSystem {
    ...
    private void putIntoSeats(FloorPlanSystem floorPlanSystem, ArrayList<Student> studentList) {
        ...
        Student tempSeats [] = new Student [tableCapacity];
        ...
        floorPlanSystem.addTable(new Table(currentTable, currentGroup, tableCapacity, tempSeats.clone()));
        ...
        for (int i = 1; i < studentList.size(); i++) {
            ...
            if ( (currentGrade != studentList.get(i).getGrade()) || (!currentGroup.equals(studentList.get(i).getGroup())) ) {
                ...
                if (nextEmptySeat != 0) {
                 currentTable++;
                    floorPlanSystem.addTable(new Table(currentTable, studentList.get(i).getGroup(), tableCapacity, tempSeats.clone()));
                }
